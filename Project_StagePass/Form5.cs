...
namespace Project_StagePass
{
    public partial class Form5 : Form
    {
        ...
        private void LblChair_Click(object sender, EventArgs e)
        {
            ...
            if (lblChair.BackColor == Color.LightGray) 
            {
        ...
        private void DisplayCustomerList()
        {
            ...
            listBoxCustomer.DataSource = ListCustomer; 
        ...
        private void btnproceedpayment_Click(object sender, EventArgs e)
        {
            ...
            if (listBoxCustomer.SelectedIndex != -1)
            {
                ...
                form4.CustomerName = selec.FullName;    
                // Ensure PaymentMethod has a public string CustomerName
                form4.CustomerEmail = selec.Email;    
                // Ensure PaymentMethod has a public string CustomerEmail
                form4.TicketCount = selec.Chairs.Count;
                // Ensure PaymentMethod has a public int TicketCount
